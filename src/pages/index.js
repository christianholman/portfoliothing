...
const IndexPage = ({ data }) => (
  <Layout>
      ...
      <p className="text-lg sm:text-xl text-blackish font-light mt-2">
          ...
          I am currently focusing on school and working on side-projects. If you want to work with me, shoot me a message on <a href="http://twitter.com/bigluxio" className="underlined underlined-blue" target="_blank">twitter</a> or get in touch via my contact page.
          
          
          <br/>
          <img class="my-5 rounded shadow w-full" src="https://media.licdn.com/dms/image/C4D16AQHIR-i6uAu33A/profile-displaybackgroundimage-shrink_350_1400/0?e=1569456000&v=beta&t=FmbceU9vrM4fo8wB7mdiQJIVKqzP8InIwmpNCR07U-Y"/>
